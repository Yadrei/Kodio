<?php
	/* 
		Classe V_Content_Lang qui représente la vue V_CONTENT_LANG en base de données
		@Author Yves P.
		@Version 1.0
	...
	*/
	...
	class V_Content_Lang 
	{
		private $id, $contentId, $language, $author, $title, $slug, $dateCre, $dateMod, $published;
