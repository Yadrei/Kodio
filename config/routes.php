<?php
	...
	return [
		...
		*/
	    ...
	    ------------------
	    */
	    BASE_URL => ['controller' => 'HomeController', 'action' => 'Index'],
	    BASE_URL."{language}" => ['controller' => 'HomeController', 'action' => 'Index'],
	    BASE_URL."{language}/accueil" => ['controller' => 'HomeController', 'action' => 'Index'],
